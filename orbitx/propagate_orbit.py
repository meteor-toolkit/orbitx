...
def propagate_orbit(
    tle_line1, tle_line2, start_time, end_time, propagation_sampling_interval
):
    """
    ...
    *** Modified from Bernardo's code ***
    ...
    while (
        ...
        saz_tmp = (
            station_frame.getAzimuth(pos_sun, inertialFrame, extrapDate) * 180.0 / pi
        )
        sel_tmp = (
            station_frame.getElevation(pos_sun, inertialFrame, extrapDate) * 180.0 / pi
        )
