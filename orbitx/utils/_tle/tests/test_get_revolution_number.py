...
from orbitx.utils._tle import get_revolution_number
...
class TestGetRevolutionNumber(unittest.TestCase):
    def test_example_0(self):
        """
        This is to test a situation when there is no TLE within the [start_date, end_date]
        """
        self.assertEqual(result_0, get_revolution_number(example_0))
