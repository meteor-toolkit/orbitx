...
def form_smpl_space(start_time, end_time, prop_smpl_interval):
    ...
    smpl_space_secs_since_2000 = np.arange(start_time_secs_since_2000, end_time_secs_since_2000, prop_smpl_interval)

    smpl_space = [datetime.timedelta(seconds=i)+datetime.datetime(2000,1,1,0,0,0) for i in smpl_space_secs_since_2000]
