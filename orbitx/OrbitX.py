...
def return_matchups(
    ...
    tle = TLE()
    tle1_line1, tle1_line2, tle1_secs_since_2000 = tle.get_tle(
        start_time, end_time, sat_1
    )
    tle2_line1, tle2_line2, tle2_secs_since_2000 = tle.get_tle(
        start_time, end_time, sat_2
    )
    ...
    sat1_smpl_breakup_idx, tle1_ref_lines = breakup_smpl_space(
        smpl_space_secs_since_2000, tle1_secs_since_2000
    )
    sat2_smpl_breakup_idx, tle2_ref_lines = breakup_smpl_space(
        smpl_space_secs_since_2000, tle2_secs_since_2000
    )
    ...
    for i in range(len(tle2_ref_lines) - 1):
        secsince2, lat2, lon2, alt2, el2, az2 = propagate_orbit(
            tle2_line1[i],
            tle2_line2[i],
