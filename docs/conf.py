#!/usr/bin/env python
#
# orbitx documentation build configuration file, created by
# cookiecutter
#
...
version = orbitx.__version__
# The full version, including alpha/beta/rc tags.
release = orbitx.__version__
